    ...
    <section className="border-y border-border-subtle bg-bg-muted px-4 py-24 sm:px-6 sm:py-28">
      <div className="mx-auto max-w-6xl">
        ...
        <h2 className="mt-3 text-4xl leading-[1.08] font-semibold tracking-tight text-content-emphasis sm:text-5xl">
          Embed it, proxy it,
          <br />
          <span className="text-content-muted">or federate a whole fleet.</span>
        </h2>
          ...
          <div className="min-w-0">
            <div className="flex h-full min-w-0 flex-col rounded-2xl border border-border-subtle bg-bg-default p-6 shadow-sm">
              ...
              <div className="mt-5 flex min-w-0 flex-1 flex-col gap-3">
                ...
                <div className="relative overflow-hidden rounded-xl bg-bg-inverted">
                  <div className="flex items-center justify-between px-4 pt-3">
                    <span className="font-mono text-xs text-white/40">check it</span>
                    <CopyButton text={healthzCommand} />
                  </div>
                  <pre className="px-4 pb-1 pt-1.5 font-mono text-[12.5px] leading-relaxed whitespace-pre-wrap break-all text-white/85">
                    {healthzCommand}
                  </pre>
                  <pre className="px-4 pb-4 font-mono text-[12.5px] leading-relaxed whitespace-pre-wrap break-all text-candy-green/80">
                    {healthzResponse}
                  </pre>
                </div>
              </div>
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-3">
          <div className="rounded-2xl border border-border-subtle bg-bg-default p-6 shadow-sm lg:col-span-1">
            ...
            <p className="mt-2 text-2sm leading-6 text-content-default">
              A Next.js app that federates every proxy: history, analytics, error tracking, email
              alerts, and a public status page per source.
            </p>
          </div>
          <div className="relative min-w-0 lg:col-span-2">
            <div className="absolute top-3 right-3 z-10">
              <CopyButton text={registerCommand} />
            </div>
