    ...
    <DialogPrimitive.Root open={showing} onOpenChange={() => onClose()}>
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          ...
          className="fixed left-1/2 top-1/2 z-50 w-full max-w-md -translate-x-1/2 -translate-y-1/2 animate-scale-in-fade rounded-lg border border-border-subtle bg-bg-default p-6 shadow-lg"
        >
